#include "ConfigParamsPnP.h"
#include "ConfigFileReader.h"

bool ConfigParamsPnP::initParamsFromConfigFile(std::string &configFilePath)
{
	...
	try
	{
		...
		// pnp parameters
		if ( !cfr.getTopLevelParameterValue("problem_specific", "input_file_path", pnp.inputFilePath) )
		{
			return false;
		}
	}
