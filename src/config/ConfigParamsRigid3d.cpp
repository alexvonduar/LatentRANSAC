#include "ConfigParamsRigid3d.h"
#include "ConfigFileReader.h"

bool ConfigParamsRigid3d::initParamsFromConfigFile(std::string &configFilePath)
{
	...
	try
	{
		...
		// pnp parameters
		if ( !cfr.getTopLevelParameterValue("problem_specific", "input_file_path", rigid3d.inputFilePath) )
		{
			return false;
		}
	}
